...
const int RELAY_ON  = HIGH; // active HIGH relay module
...
void setup() {
  // Force the relay OFF as early as possible, before anything else runs,
  // to prevent it from glitching on briefly at power-up/reset.
...
void showLose() {
  ...
  display.println(F("Daddy will"));
  display.setCursor(0, 35);
  display.println(F("punish you!"));
  display.display();
